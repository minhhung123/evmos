...
func Setup(
	...
	db := dbm.NewMemDB()
	app := NewEvmos(log.NewNopLogger(), db, nil, true, map[int64]bool{}, DefaultNodeHome, 5, encoding.MakeConfig(ModuleBasics), GetEnabledProposals(), simapp.EmptyAppOptions{}, EmptyWasmOpts)
	if !isCheckTx {
